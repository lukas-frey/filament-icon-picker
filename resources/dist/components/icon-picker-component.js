...
function iconPickerComponent({
  ...
  return {
    ...
    setElementIcon(element, id, after = null) {
      this.getIconSvgUsing(id).then((svg) => element.innerHTML = svg).finally(after);
    },
    createFuseObject() {
      const options = {
        includeScore: true,
